...
namespace ForgetMeNot.Content.Entities.Items.Weapons.Ranged.Bow.BowProj
{
    ...
    public class ArathiPurpleProj : ModProjectile
    {
        ...
        {
            int num = Dust.NewDust(base.Projectile.Center, 0, 0, 14, 0f, 0f, 0, default(Color), 1.15f);
        ...
        {
            return new Color?(new Color(75, 0, 130));
        }
